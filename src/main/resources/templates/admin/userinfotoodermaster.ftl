...
<table class="easyui-datagrid" id="query"  title="DataGrid Complex Toolbar"
       data-options="rownumbers:true,singleSelect:true,url:'http://localhost:8080/ordermaster/querywithuser?userid='+${userid},method:'get',toolbar:'#tb',footer:'#ft',
       pagination:true,pageNumber:1,pageList:[5,10,15,20,25],fitColumns:true">
    <thead>
    <tr>
        <th data-options="field:'orderId',width:80">订单号</th>
        <th data-options="field:'buyerName',width:100">用户名</th>
        <th data-options="field:'buyerUserid',width:100">用户编号</th>
